...
const navLinks = [
  ...
  { name: 'Process', section: 'process', href: '/#/process' },
  { name: 'Projects', section: 'projects', href: '/#/projects' },
  { name: 'Features', section: 'features', href: '/#/features' },
  { name: 'Testimonials', section: 'testimonials', href: '/#/testimonials' },
...
const Header = ({ activeSection, onQuoteClick }) => {
  ...
  // ✅ Hash URL + smooth scroll (SEO safe)
      ...
      >
        <div className="container mx-auto max-w-7xl px-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              href="tel:9381187905"
              className="flex items-center gap-2 text-foreground/80 hover:text-blue-600 transition-colors"
            >
              <Phone size={18} />
            ...
            <Button
              ...
              className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full shadow-lg hover:scale-105 transition-transform"
            >
        ...
        <nav className="sr-only">
          <a href="/#/services">Website Design Services in Vijayawada</a>
          ...
          >
            ...
            <nav className="flex flex-col items-center justify-center h-full gap-8">
              ...
              <Button
                ...
                size="lg"
                className="mt-8 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full"
              >
                Get a Free Quote
              </Button>
            </nav>
